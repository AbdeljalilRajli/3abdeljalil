        ...
        <div className="container container-1290">
          <div className="row">
            <div className="col-lg-12">
              <h2 className="hero-title style-two mt-65 mb-30 wow fadeInUp delay-0-2s">
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="image mb-30 wow fadeInUp delay-0-2s">
                <img
                  src="assets/images/projects/aquilla/image1.webp"
                  alt="Project"
                />
              </div>
            </div>
            <div className="col-lg-6">
              <div className="image mb-30 wow fadeInUp delay-0-4s">
                <img
                  src="assets/images/projects/aquilla/image2.webp"
                  alt="Project"
                />
              </div>
            </div>
            <div className="col-lg-6">
              <div className="image mb-30 wow fadeInUp delay-0-4s">
                <img
                  src="assets/images/projects/aquilla/image3.webp"
                  alt="Project"
                />
              </div>
            </div>
